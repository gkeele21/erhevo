...
const form = useForm({
    ...
    attachment_url: props.post.attachment_url || null,
    attachment_path: props.post.attachment_path || null,
    attachment_name: props.post.attachment_name || null,
    attachment_size: props.post.attachment_size || null,
