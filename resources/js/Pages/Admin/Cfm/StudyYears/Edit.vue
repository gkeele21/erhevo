...
const form = useForm({
    year: props.studyYear.year,
    title: props.studyYear.title,
    description: props.studyYear.description || '',
    volume_ids: props.studyYear.volumes?.map(v => v.id) || [],
});

const submit = () => {
    form.put(route('admin.cfm.study-years.update', props.studyYear.id));
};
...
<template>
    <AdminLayout :title="`Edit ${studyYear.title}`">
        <div class="max-w-2xl">
            <div class="bg-white rounded-lg shadow border border-navy-50 p-6">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <Link :href="route('admin.cfm.study-years.show', studyYear.id)">
