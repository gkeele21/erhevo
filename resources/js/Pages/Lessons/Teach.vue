...
function summary(item) {
    ...
    switch (item.type) {
        ...
        case 'text': return c.post_title || stripHtml(item.content) || 'Empty'
        case 'scripture_help': return c.post_title || stripHtml(item.content) || 'Scripture help'
